...
var
  i: integer;
  Authorization: TaOPCAuthorization;
...
begin
  ...
  aCancel := False;
  Authorization := TaOPCAuthorization.Create(nil);
  try
...
begin
  ...
  try
    ...
    begin
      ...
      aOPCConnection.OPCSource.Language := StrToLanguage(aCustomIniFile.ReadString(aConnectionSection, 'Language', 'ru'));
