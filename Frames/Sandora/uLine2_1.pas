...
function TLine2_1.GetOPCSource: TaCustomMultiOPCSource;
begin
  Result := TaCustomMultiOPCSource(M166.OPCSource);
end;

function TLine2_1.GetP181: string;
begin
end;

procedure TLine2_1.LT102Change(Sender: TObject);
begin
  gLT102.Value := IntToStr(1000-StrToIntDef(LT102.Value,0));
end;

procedure TLine2_1.M162Change(Sender: TObject);
begin
  M162In.Value := IfThen(M162.IsActive,'3','0');
end;

procedure TLine2_1.M166MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
...
procedure TLine2_1.MR181Change(Sender: TObject);
begin
  _Out1.Value := IfThen(MR181.IsActive,'2','0');
end;

procedure TLine2_1.SetAllowClick(const Value: boolean);
var
  I: Integer;
...
procedure TLine2_1.SetOPCSource(const Value: TaCustomMultiOPCSource);
var
  i: Integer;
begin
...
procedure TLine2_1.SetP181(const Value: string);
begin
end;

procedure TLine2_1._Out1Change(Sender: TObject);
begin
