...
procedure TSt3P3.VT712Change(Sender: TObject);
begin
  V803OutChange(sender);
...
procedure TSt3P3.aOPCLabel11DblClick(Sender: TObject);
var
...
procedure TSt3P3.cbVT712Click(Sender: TObject);
begin
  VT712.Value := IfThen((Sender as TCheckBox).Checked,'1','0');
end;

procedure TSt3P3.V802Change(Sender: TObject);
begin
...
procedure TSt3P3.V827Change(Sender: TObject);
begin
  if CheckRevers then exit;
...
procedure TSt3P3.V801Change(Sender: TObject);
begin
...
procedure TSt3P3.V807Change(Sender: TObject);
begin
...
procedure TSt3P3.V864Change(Sender: TObject);
begin
...
procedure TSt3P3.V828Change(Sender: TObject);
begin
  V803Change(self);
...
procedure TSt3P3.V803Change(Sender: TObject);
begin
  ...
  begin
    V803Out.Value := IfThen(V828Out.IsActive,V828Out.Value,V821Out.Value);
    //  V803Out.Value := V828Out.Value;
  end;
...
procedure TSt3P3.HR7000Change(Sender: TObject);
var
  v:boolean;
begin
  v:=(HR7000.Value = '1');
...
//  V806Out2.Value := IfThen(v,'0',V803Out.Value);
  V806Out2.Value := IfThen(v,'0',Sw16.Value);


end;

procedure TSt3P3.V803OutChange(Sender: TObject);
begin
  if (ModeProvider.Value = '1') or
    (V832.IsActive) or
    ((ModeProvider.Value = '4') and (V864.IsActive)) then
  begin
    Sw1.Value := '0';
    Sw2.Value := '0';
  end
...
procedure TSt3P3.CheckBox15Click(Sender: TObject);
begin
  HR7000.Value := IfThen((Sender as TCheckBox).Checked,'1','0');

end;

procedure TSt3P3.ProizvChange(Sender: TObject);
begin
...
procedure TSt3P3.V802MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
...
function TSt3P3.GetOPCSource: TaCustomMultiOPCSource;
begin
  Result := (V806.OPCSource as TaCustomMultiOPCSource);
end;

procedure TSt3P3.SetOPCSource(const Value: TaCustomMultiOPCSource);
var
  i: Integer;
begin
...
constructor TSt3P3.Create(AOwner: TComponent);
begin
  inherited;
