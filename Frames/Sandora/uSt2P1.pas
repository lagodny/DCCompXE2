...
type
  TSt2P1 = class(TaOPCFrame)
    ...
    procedure VP571MouseDown(Sender: TObject; Button: TMouseButton;
    ...
    procedure VP571Change(Sender: TObject);
...
procedure TSt2P1.P581Change(Sender: TObject);
begin
...
procedure TSt2P1.V585Change(Sender: TObject);
var
  m:integer;
begin
...
procedure TSt2P1.V562InChange(Sender: TObject);
begin
  V562Out.Value := IfThen(V562.IsActive,V562In.Value,'0');
end;

procedure TSt2P1.V593Change(Sender: TObject);
begin
...
procedure TSt2P1.V559InChange(Sender: TObject);
begin
...
procedure TSt2P1.VP571MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
...
procedure TSt2P1.ModeProviderChange(Sender: TObject);
var
  mode:integer;
begin
...
procedure TSt2P1.V592InChange(Sender: TObject);
begin
  V592Out.Value := IfThen(not V592.IsActive,V592In.Value,'0');
end;

procedure TSt2P1.Plata3Change(Sender: TObject);
begin
...
procedure TSt2P1.V591InChange(Sender: TObject);
begin
  V591Out.Value := IfThen(V591.IsActive,V591In.Value,'0');
end;

procedure TSt2P1.V514Change(Sender: TObject);
begin
  V514Out.Value := IfThen(v514.IsActive,V514In.Value,'0');
end;

procedure TSt2P1.V557Change(Sender: TObject);
begin
...
procedure TSt2P1.V556Change(Sender: TObject);
begin
...
procedure TSt2P1.v552Change(Sender: TObject);
begin
  v552Out1.Value := IfThen(v552.IsActive,v552In.Value,'0');
end;

procedure TSt2P1.V551In2Change(Sender: TObject);
begin
  ...
  begin
    if Revers.IsActive then
      V551In1.Value := '0';
    v552In.Value := V551In1.Value;
    v565InChange(Self);
  end
end;

procedure TSt2P1.v565InChange(Sender: TObject);
begin
...
procedure TSt2P1.v542Change(Sender: TObject);
begin
  v542Out.Value := IfThen(v542.IsActive,v542In.Value,'0');
end;

procedure TSt2P1.v574Change(Sender: TObject);
begin
  V574Out.Value := IfThen(v574.IsActive,V574In.Value,'0');
end;

procedure TSt2P1.VP571Change(Sender: TObject);
begin
  V571In.Value := IfThen(VP571.IsActive,v552Out1.Value,'0');
end;

procedure TSt2P1.v565Out2Change(Sender: TObject);
begin
...
procedure TSt2P1.VP528InChange(Sender: TObject);
begin
  VP528Out.Value := IfThen(VP528.IsActive,VP528In.Value,'0');
end;

procedure TSt2P1.P527InChange(Sender: TObject);
begin
  P527Out.Value := IfThen((P527.IsActive) and (P527In.IsActive),
    P527In.Value,VP528Out.Value);
end;

procedure TSt2P1.V566In2Change(Sender: TObject);
begin
...
procedure TSt2P1.V514OutChange(Sender: TObject);
begin
...
procedure TSt2P1.P530Change(Sender: TObject);
begin
...
procedure TSt2P1.P530OutChange(Sender: TObject);
begin
  if Revers.IsActive then
  begin
...
procedure TSt2P1.Tank2OutChange(Sender: TObject);
var
  v:integer;
begin
  ...
  case v of
    ...
    4: Tank2Level.ForeColor := $B3FFFF;
  end;
end;

function TSt2P1.GetOPCSource: TaCustomMultiOPCSource;
begin
  Result := (Plata3.OPCSource as TaCustomMultiOPCSource);
end;

procedure TSt2P1.SetOPCSource(const Value: TaCustomMultiOPCSource);
var
  i: Integer;
begin
...
procedure TSt2P1.V584Change(Sender: TObject);
begin
  V584Out.Value := IfThen(V584.IsActive,'1','0');
end;

constructor TSt2P1.Create(AOwner: TComponent);
begin
  inherited;
...
procedure TSt2P1.V517InChange(Sender: TObject);
begin
  V517Out.Value := IfThen(V517.IsActive,V517In.Value,'0');
end;

procedure TSt2P1.PlataDInput1Change(Sender: TObject);
begin
  if Revers.IsActive then
