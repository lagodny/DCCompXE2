...
uses
  ...
  , uChartFrame
  , ukzTempFrame
  , ukzCompressorShort, ukzCompressorDetail
  ;
...
procedure Register;
begin
  RegisterComponents('OPC Frames', [TChartFrame]);

  RegisterComponents('OPC Frames', [TBoilerFrame]);

  RegisterComponents('OPC Frames', [TkzTemp]);
  RegisterComponents('OPC Frames', [TkzCompressorShort]);
  RegisterComponents('OPC Frames', [TkzCompressorDetail]);

  RegisterPropertiesInCategory('DC', TaOPCFrame, ['ID', '*LookupList','*OPCSource']);
