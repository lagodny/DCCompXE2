...
uses
  ...
  Dialogs, Menus, ActnList, ExtCtrls, TeeProcs, AppEvnts,
  ...
  aOPCLineSeries,
  aOPCConnectionList, aOPCLog, aOPCUtils, ImgList, Vcl.Touch.GestureMgr
  ;
...
{$IFDEF TEECHARTEDITOR}
  , TeeEdit, TeeEditCha, TeeRussian, TeeStore
{$ENDIF}
  , aOPCLookupList;
...
begin
  ...
  begin
    ...
    begin
      ...
      ClickedSerie.Scale := StrToFloatDef(sNewScale, ClickedSerie.Scale);
    end;
  end;
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      ClickedSerie.Shift := StrToFloatDef(sNewShift, ClickedSerie.Shift);
    end;
  end;
end;
