...
//class function TCustomRec.OpenDialog(aID: Integer; aAfterEditProc: TOnAfterEditProc): Boolean;
//var
//  aNewID: Integer;
//  f: TCustomRec;
//begin
//  f := Self.Create(nil);
//  try
//    f.PopupParent := MainForm;
//    f.FormStorage.AppStorage := MainForm.RegistryStorage;
//
//    f.DataToControls(aID);
//    if f.ShowModal = mrOk then
//    begin
//      aNewID := f.ControlsToData;
//      if Assigned(aAfterEditProc) then
//        aAfterEditProc(aNewID);
//    end;
//
//
//  finally
